...
def add_job(functName:str,parameters:dict, status="submitted"):
    ...
    worker_functs = ['__annotations__', '__builtins__', '__cached__', '__doc__', '__file__', '__loader__', '__name__', '__package__', '__spec__', 'cardio_data', 'do_work', 'return_topics', 'test_work','max_affected', 'graph_rf']
